...
class SwitchCaseComplement extends StatelessWidget {
  ...
  const SwitchCaseComplement(
      {required this.controller, required this.personMap, super.key});
    ...
    return ValueListenableBuilder(
        ...
        builder: (_, value, __) {
          switch (value) {
            case 0:
              Map triangle =
                  Triangle.reducaoNumerologica(personMap.listNumbers, 0);
            ...
            case 1:
              ...
              Map triangle = Triangle.reducaoNumerologica(
                  personMap.listNumbers, numberEdit);
